...
<div id="vToolbar" class="nc-appbar">
  <div class="nc-appbar-tabs" id="appBarTabs">
    ...
    <?php } ?>
    <ul class="tools">
      <li><a onclick="$('.layer-3').trigger('click')"  style="cursor: pointer;" id="chat_show_user" class="chat TA_delay"><div class="tools_img TA"></div><span class="TA">在线客服</span><i id="new_msg" class="new_msg" style="display:none;"></i></a></li>
     ...
     <script src="https://qiyukf.com/script/064f62a3b4062af4595a6a586828835f.js" defer async></script>
...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    <div class="user-entry">
	  ...
	  <span><a href="<?php echo urlMember('login'); ?>">登录</a></span>|<span><a href="<?php echo urlLogin('login', 'register'); ?>">注册</a></span>|
	...
	<span class="other">
      ...
      <dl class="my-cart">
        ...
        <input type="hidden" value="search" id="search_act" name="act">
         <input placeholder="请输入搜索商品关键字" name="keyword" id="keyword" type="text" class="input-text" value="<?php echo $_GET['keyword']; ?>" maxlength="60" x-webkit-speech lang="zh-CN" onwebkitspeechchange="foo()" x-webkit-grammar="builtin:search" />
...
$('a[nctype="close-barLoginBox"]').click(function() {
    ...
    $('#rtoobar_cart_count').html(<?php echo $output['cart_goods_num']; ?>).show();<?php } ?>
});
</script> 
